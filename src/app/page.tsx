    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-background font-sans">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-background sm:items-start">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-solid border-foreground/20 px-5 transition-colors hover:border-foreground/40 hover:bg-foreground/5 md:w-[158px]"
